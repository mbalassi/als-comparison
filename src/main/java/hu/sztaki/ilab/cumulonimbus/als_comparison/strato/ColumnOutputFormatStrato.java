...
public class ColumnOutputFormatStrato extends
	...
	public ColumnOutputFormatStrato() {
		super();
	}

	public ColumnOutputFormatStrato(String outputPath) {
	...
	public void setInputType(TypeInformation<?> type) {
		if (!type.isTupleType()) {
			throw new InvalidProgramException("The "
					+ ColumnOutputFormatStrato.class.getSimpleName()
