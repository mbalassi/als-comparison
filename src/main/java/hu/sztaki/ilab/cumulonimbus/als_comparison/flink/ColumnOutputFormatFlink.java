...
public class ColumnOutputFormatFlink extends
	...
	public ColumnOutputFormatFlink() {
		super();
	}

	public ColumnOutputFormatFlink(String outputPath) {
	...
	public void setInputType(TypeInformation<?> type) {
		if (!type.isTupleType()) {
			throw new InvalidProgramException("The "
					+ ColumnOutputFormatFlink.class.getSimpleName()
